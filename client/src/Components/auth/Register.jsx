...
function Register() {
  ...
  return (
    <div>
      <div className="form">
        <h1 className="opening">Sign-up and Apply For Free</h1>
              ...
              <div className="p-8 lg:w-1/2">
                ...
                <form onSubmit={handleSignup}>
                  ...
                  <button 
                    type="submit"
                    disabled={isLoading}
                    className="bg-blue-500 h-9 text-white font-bold py-2 mt-4 px-4 w-full rounded hover:bg-blue-600 disabled:bg-blue-300"
                  >
